...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ChargebackApi~chargebackCallback
     ...
     * @param {module:api/ChargebackApi~chargebackCallback} callback The callback function, accepting three arguments: error, data, response
