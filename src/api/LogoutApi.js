...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/EventResponse', 'model/Logout'], factory);
    ...
    root.ThirdwatchApi.LogoutApi = factory(root.ThirdwatchApi.ApiClient, root.ThirdwatchApi.ErrorResponse, root.ThirdwatchApi.EventResponse, root.ThirdwatchApi.Logout);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/Logout} JSON Pass logout status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain logout info.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/EventResponse}
     */
    this.logout = function(JSON) {
      var postBody = JSON;
