...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ai_thirdwatch/ApiClient', 'ai_thirdwatch/model/Custom', 'ai_thirdwatch/model/ErrorResponse', 'ai_thirdwatch/model/EventResponse'], factory);
    ...
    root.thirdwatch_api.CustomEventApi = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.Custom, root.thirdwatch_api.ErrorResponse, root.thirdwatch_api.EventResponse);
  }
   ...
   * @alias module:ai_thirdwatch/api/CustomEventApi
   * @class
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the customEvent operation.
     * @callback module:ai_thirdwatch/api/CustomEventApi~customEventCallback
     ...
     * @param {module:ai_thirdwatch/model/Custom} JSON Pass order status to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain custom info.
     * @param {module:ai_thirdwatch/api/CustomEventApi~customEventCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:ai_thirdwatch/model/EventResponse}
     */
    this.customEvent = function(JSON, callback) {
      var postBody = JSON;
