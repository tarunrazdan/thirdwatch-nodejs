...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ai_thirdwatch/ApiClient', 'ai_thirdwatch/model/ErrorResponse', 'ai_thirdwatch/model/EventResponse', 'ai_thirdwatch/model/UpdateAccount'], factory);
    ...
    root.thirdwatch_api.UpdateAccountApi = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.ErrorResponse, root.thirdwatch_api.EventResponse, root.thirdwatch_api.UpdateAccount);
  }
   ...
   * @module ai_thirdwatch/api/UpdateAccountApi
   * @version 0.0.1
   */

  /**
   * Constructs a new UpdateAccountApi. 
   * @alias module:ai_thirdwatch/api/UpdateAccountApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:ai_thirdwatch/api/UpdateAccountApi~updateAccountCallback
     ...
     * @param {module:ai_thirdwatch/model/UpdateAccount} JSON Pass user details after update or change in user info. Only &#x60;_userID&#x60; is required field. But this should contain user info.
     * @param {module:ai_thirdwatch/api/UpdateAccountApi~updateAccountCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:ai_thirdwatch/model/EventResponse}
     */
    this.updateAccount = function(JSON, callback) {
      var postBody = JSON;
