...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ai_thirdwatch/ApiClient', 'ai_thirdwatch/model/ErrorResponse', 'ai_thirdwatch/model/EventResponse', 'ai_thirdwatch/model/Transaction'], factory);
    ...
    root.thirdwatch_api.TransactionApi = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.ErrorResponse, root.thirdwatch_api.EventResponse, root.thirdwatch_api.Transaction);
  }
  ...
  /**
   * Transaction service.
   * @module ai_thirdwatch/api/TransactionApi
   * @version 0.0.2
   */

  /**
   * Constructs a new TransactionApi. 
   * @alias module:ai_thirdwatch/api/TransactionApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:ai_thirdwatch/api/TransactionApi~transactionCallback
     ...
     * @param {module:ai_thirdwatch/model/Transaction} JSON Pass transaction results to thirdwatch. Only &#x60;_userID&#x60; is required field. But this should contain transaction info.
     * @param {module:ai_thirdwatch/api/TransactionApi~transactionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:ai_thirdwatch/model/EventResponse}
     */
    this.transaction = function(JSON, callback) {
      var postBody = JSON;
