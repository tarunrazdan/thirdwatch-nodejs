...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ai_thirdwatch/ApiClient', 'ai_thirdwatch/model/BillingAddress', 'ai_thirdwatch/model/CustomInfo', 'ai_thirdwatch/model/PaymentMethod', 'ai_thirdwatch/model/ShippingAddress'], factory);
    ...
    root.thirdwatch_api.Transaction = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.BillingAddress, root.thirdwatch_api.CustomInfo, root.thirdwatch_api.PaymentMethod, root.thirdwatch_api.ShippingAddress);
  }
   ...
   * @alias module:ai_thirdwatch/model/Transaction
   * @class
   * @param orderId {String} The ID for tracking this order in your system.
   * @param transactionStatus {String} Use _transactionStatus to indicate the status of the transaction. The value can be \"_success\" (default value), \"_failure\" or \"_pending\". For instance, If the transaction was rejected by the payment gateway, set the value to \"_failure\".
   */
  var exports = function(orderId, transactionStatus) {
    var _this = this;
    ...
    _this['_transactionStatus'] = transactionStatus;
   ...
   * @param {module:ai_thirdwatch/model/Transaction} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/Transaction} The populated <code>Transaction</code> instance.
   */
  ...
  /**
   * @member {module:ai_thirdwatch/model/PaymentMethod} _paymentMethod
   */
