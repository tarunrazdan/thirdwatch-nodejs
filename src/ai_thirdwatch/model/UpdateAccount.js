...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.UpdateAccount = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.BillingAddress, root.thirdwatch_api.CustomInfo, root.thirdwatch_api.PaymentMethod, root.thirdwatch_api.Promotion, root.thirdwatch_api.ShippingAddress);
  }
   ...
   * @module ai_thirdwatch/model/UpdateAccount
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>UpdateAccount</code>.
   * @alias module:ai_thirdwatch/model/UpdateAccount
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/UpdateAccount} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/UpdateAccount} The populated <code>UpdateAccount</code> instance.
   */
