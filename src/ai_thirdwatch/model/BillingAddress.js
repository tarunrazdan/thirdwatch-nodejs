...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.BillingAddress = factory(root.thirdwatch_api.ApiClient);
  }
   ...
   * @alias module:ai_thirdwatch/model/BillingAddress
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/BillingAddress} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/BillingAddress} The populated <code>BillingAddress</code> instance.
   */
