...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.ReportItem = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo);
  }
   ...
   * @alias module:ai_thirdwatch/model/ReportItem
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/ReportItem} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/ReportItem} The populated <code>ReportItem</code> instance.
   */
  ...
  /**
   * The unique ID for the item that is being reported. Note - item IDs are case sensitive.
