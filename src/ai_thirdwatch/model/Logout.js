...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.Logout = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo);
  }
   ...
   * @alias module:ai_thirdwatch/model/Logout
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/Logout} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/Logout} The populated <code>Logout</code> instance.
   */
