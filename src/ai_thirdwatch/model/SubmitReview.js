...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.SubmitReview = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo);
  }
  ...
  /**
   * Constructs a new <code>SubmitReview</code>.
   * @alias module:ai_thirdwatch/model/SubmitReview
   * @class
   */
  ...
  /**
   * Constructs a <code>SubmitReview</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ai_thirdwatch/model/SubmitReview} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/SubmitReview} The populated <code>SubmitReview</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_reviewTitle')) {
        obj['_reviewTitle'] = ApiClient.convertToType(data['_reviewTitle'], 'String');
      }
      if (data.hasOwnProperty('_reviewContent')) {
        obj['_reviewContent'] = ApiClient.convertToType(data['_reviewContent'], 'String');
      }
      if (data.hasOwnProperty('_itemId')) {
        obj['_itemId'] = ApiClient.convertToType(data['_itemId'], 'String');
      }
      if (data.hasOwnProperty('_submissionStatus')) {
        obj['_submissionStatus'] = ApiClient.convertToType(data['_submissionStatus'], 'String');
      }
      if (data.hasOwnProperty('_rating')) {
        obj['_rating'] = ApiClient.convertToType(data['_rating'], 'String');
      }
   ...
   * @member {String} _reviewTitle
   */
  exports.prototype['_reviewTitle'] = undefined;
  /**
   * The text content of review submitted.
   * @member {String} _reviewContent
   */
  exports.prototype['_reviewContent'] = undefined;
  /**
   ...
   * @member {String} _submissionStatus
   */
  exports.prototype['_submissionStatus'] = undefined;
  /**
   * The rating provided by the user. e.g. \"4\"
   * @member {String} _rating
   */
  exports.prototype['_rating'] = undefined;
  /**
