...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ai_thirdwatch/ApiClient', 'ai_thirdwatch/model/CustomInfo', 'ai_thirdwatch/model/Promotion'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CustomInfo'), require('./Promotion'));
  } else {
    // Browser globals (root is window)
    if (!root.thirdwatch_api) {
      root.thirdwatch_api = {};
    }
    root.thirdwatch_api.AddPromotion = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo, root.thirdwatch_api.Promotion);
  }
}(this, function(ApiClient, CustomInfo, Promotion) {
  'use strict';
  ...
  /**
   * The AddPromotion model module.
   * @module ai_thirdwatch/model/AddPromotion
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>AddPromotion</code>.
   * @alias module:ai_thirdwatch/model/AddPromotion
   * @class
   */
  ...
  /**
   * Constructs a <code>AddPromotion</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:ai_thirdwatch/model/AddPromotion} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/AddPromotion} The populated <code>AddPromotion</code> instance.
   */
