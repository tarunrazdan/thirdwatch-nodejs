...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.ItemStatus = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo);
  }
   ...
   * @alias module:ai_thirdwatch/model/ItemStatus
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/ItemStatus} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/ItemStatus} The populated <code>ItemStatus</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_itemStatus')) {
        obj['_itemStatus'] = ApiClient.convertToType(data['_itemStatus'], 'String');
      }
   ...
   * @member {String} _itemStatus
   */
  exports.prototype['_itemStatus'] = undefined;
  /**
