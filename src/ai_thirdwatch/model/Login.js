...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.Login = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo);
  }
   ...
   * @module ai_thirdwatch/model/Login
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>Login</code>.
   * @alias module:ai_thirdwatch/model/Login
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/Login} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/Login} The populated <code>Login</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_loginStatus')) {
        obj['_loginStatus'] = ApiClient.convertToType(data['_loginStatus'], 'String');
      }
  ...
  /**
   * Use _loginStatus to represent the success or failure of the login attempt. e.g. _success, _failure
   * @member {String} _loginStatus
   */
  exports.prototype['_loginStatus'] = undefined;
  /**
