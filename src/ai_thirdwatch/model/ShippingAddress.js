...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.ShippingAddress = factory(root.thirdwatch_api.ApiClient);
  }
   ...
   * @module ai_thirdwatch/model/ShippingAddress
   * @version 0.0.2
   */
   ...
   * @alias module:ai_thirdwatch/model/ShippingAddress
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/ShippingAddress} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/ShippingAddress} The populated <code>ShippingAddress</code> instance.
   */
