...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ai_thirdwatch/ApiClient', 'ai_thirdwatch/model/Seller'], factory);
   ...
   * @module ai_thirdwatch/model/Item
   * @version 0.0.2
   */
   ...
   * @alias module:ai_thirdwatch/model/Item
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/Item} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/Item} The populated <code>Item</code> instance.
   */
  ...
  /**
   * @member {module:ai_thirdwatch/model/Seller} _seller
   */
