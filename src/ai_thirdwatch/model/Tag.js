...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.Tag = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo);
  }
   ...
   * @module ai_thirdwatch/model/Tag
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>Tag</code>.
   * @alias module:ai_thirdwatch/model/Tag
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/Tag} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/Tag} The populated <code>Tag</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_isBad')) {
        obj['_isBad'] = ApiClient.convertToType(data['_isBad'], 'Boolean');
      }
   ...
   * @member {Boolean} _isBad
   */
  exports.prototype['_isBad'] = undefined;
  /**
