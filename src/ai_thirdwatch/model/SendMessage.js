...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.SendMessage = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.CustomInfo);
  }
   ...
   * @module ai_thirdwatch/model/SendMessage
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>SendMessage</code>.
   * @alias module:ai_thirdwatch/model/SendMessage
   * @class
   */
   ...
   * @param {module:ai_thirdwatch/model/SendMessage} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/SendMessage} The populated <code>SendMessage</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('_recipientUserId')) {
        obj['_recipientUserId'] = ApiClient.convertToType(data['_recipientUserId'], 'String');
      }
      if (data.hasOwnProperty('_subject')) {
        obj['_subject'] = ApiClient.convertToType(data['_subject'], 'String');
      }
   ...
   * @member {String} _recipientUserId
   */
  exports.prototype['_recipientUserId'] = undefined;
  /**
   * The subject of the message.
   * @member {String} _subject
   */
  exports.prototype['_subject'] = undefined;
  /**
   * The text content of the message.
   * @member {String} _content
   */
  exports.prototype['_content'] = undefined;
  /**
