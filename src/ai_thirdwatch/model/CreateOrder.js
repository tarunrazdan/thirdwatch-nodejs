...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.thirdwatch_api.CreateOrder = factory(root.thirdwatch_api.ApiClient, root.thirdwatch_api.BillingAddress, root.thirdwatch_api.CustomInfo, root.thirdwatch_api.Item, root.thirdwatch_api.PaymentMethod, root.thirdwatch_api.Promotion, root.thirdwatch_api.ShippingAddress);
  }
   ...
   * @module ai_thirdwatch/model/CreateOrder
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>CreateOrder</code>.
   * @alias module:ai_thirdwatch/model/CreateOrder
   * @class
   ...
   * @param {module:ai_thirdwatch/model/CreateOrder} obj Optional instance to populate.
   * @return {module:ai_thirdwatch/model/CreateOrder} The populated <code>CreateOrder</code> instance.
   */
