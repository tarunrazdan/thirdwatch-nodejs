...
(function(root, factory) {
   ...
   * @module model/Chargeback
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>Chargeback</code>.
   * @alias module:model/Chargeback
   * @class
   */
   ...
   * @param {module:model/Chargeback} obj Optional instance to populate.
   * @return {module:model/Chargeback} The populated <code>Chargeback</code> instance.
   */
