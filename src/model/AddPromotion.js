...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CustomInfo', 'model/Promotion'], factory);
   ...
   * @module model/AddPromotion
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>AddPromotion</code>.
   * @alias module:model/AddPromotion
   * @class
   */
   ...
   * @param {module:model/AddPromotion} obj Optional instance to populate.
   * @return {module:model/AddPromotion} The populated <code>AddPromotion</code> instance.
   */
