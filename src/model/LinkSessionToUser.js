...
(function(root, factory) {
   ...
   * @module model/LinkSessionToUser
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>LinkSessionToUser</code>.
   * @alias module:model/LinkSessionToUser
   * @class
   */
   ...
   * @param {module:model/LinkSessionToUser} obj Optional instance to populate.
   * @return {module:model/LinkSessionToUser} The populated <code>LinkSessionToUser</code> instance.
   */
