...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ThirdwatchApi.AddToCart = factory(root.ThirdwatchApi.ApiClient, root.ThirdwatchApi.CustomInfo, root.ThirdwatchApi.Item);
  }
   ...
   * @module model/AddToCart
   * @version 0.0.1
   */

  /**
   * Constructs a new <code>AddToCart</code>.
   * @alias module:model/AddToCart
   * @class
   */
   ...
   * @param {module:model/AddToCart} obj Optional instance to populate.
   * @return {module:model/AddToCart} The populated <code>AddToCart</code> instance.
   */
