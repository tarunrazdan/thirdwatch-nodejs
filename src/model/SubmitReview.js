...
(function(root, factory) {
   ...
   * @module model/SubmitReview
   * @version 0.0.2
   */

  /**
   * Constructs a new <code>SubmitReview</code>.
   * @alias module:model/SubmitReview
   * @class
   */
   ...
   * @param {module:model/SubmitReview} obj Optional instance to populate.
   * @return {module:model/SubmitReview} The populated <code>SubmitReview</code> instance.
   */
