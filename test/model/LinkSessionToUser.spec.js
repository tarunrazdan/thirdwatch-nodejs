...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.LinkSessionToUser();
  });
  ...
  describe('LinkSessionToUser', function() {
    it('should create an instance of LinkSessionToUser', function() {
      // uncomment below and update the code to test LinkSessionToUser
      //var instane = new thirdwatch_api.LinkSessionToUser();
      //expect(instance).to.be.a(thirdwatch_api.LinkSessionToUser);
    });
