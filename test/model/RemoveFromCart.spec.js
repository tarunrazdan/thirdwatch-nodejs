...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.RemoveFromCart();
  });
  ...
  describe('RemoveFromCart', function() {
    it('should create an instance of RemoveFromCart', function() {
      // uncomment below and update the code to test RemoveFromCart
      //var instane = new thirdwatch_api.RemoveFromCart();
      //expect(instance).to.be.a(thirdwatch_api.RemoveFromCart);
    });
    ...
    it('should have the property item (base name: "_item")', function() {
