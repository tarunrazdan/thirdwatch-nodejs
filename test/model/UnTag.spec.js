...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.UnTag();
  });
  ...
  describe('UnTag', function() {
    it('should create an instance of UnTag', function() {
      // uncomment below and update the code to test UnTag
      //var instane = new thirdwatch_api.UnTag();
      //expect(instance).to.be.a(thirdwatch_api.UnTag);
    });
