...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.AddPromotion();
  });
  ...
  describe('AddPromotion', function() {
    it('should create an instance of AddPromotion', function() {
      // uncomment below and update the code to test AddPromotion
      //var instane = new thirdwatch_api.AddPromotion();
      //expect(instance).to.be.a(thirdwatch_api.AddPromotion);
    });
