...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.Logout();
  });
  ...
  describe('Logout', function() {
    it('should create an instance of Logout', function() {
      // uncomment below and update the code to test Logout
      //var instane = new thirdwatch_api.Logout();
      //expect(instance).to.be.a(thirdwatch_api.Logout);
    });
