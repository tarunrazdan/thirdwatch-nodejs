...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.AddToCart();
  });
  ...
  describe('AddToCart', function() {
    it('should create an instance of AddToCart', function() {
      // uncomment below and update the code to test AddToCart
      //var instane = new thirdwatch_api.AddToCart();
      //expect(instance).to.be.a(thirdwatch_api.AddToCart);
    });
