...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.ItemStatus();
  });
  ...
  describe('ItemStatus', function() {
    it('should create an instance of ItemStatus', function() {
      // uncomment below and update the code to test ItemStatus
      //var instane = new thirdwatch_api.ItemStatus();
      //expect(instance).to.be.a(thirdwatch_api.ItemStatus);
    });
    ...
    it('should have the property itemStatus (base name: "_itemStatus")', function() {
