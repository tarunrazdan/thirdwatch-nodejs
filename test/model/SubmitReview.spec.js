...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new thirdwatch_api.SubmitReview();
  });
  ...
  describe('SubmitReview', function() {
    it('should create an instance of SubmitReview', function() {
      // uncomment below and update the code to test SubmitReview
      //var instane = new thirdwatch_api.SubmitReview();
      //expect(instance).to.be.a(thirdwatch_api.SubmitReview);
    });
    ...
    it('should have the property reviewTitle (base name: "_reviewTitle")', function() {
      // uncomment below and update the code to test the property reviewTitle
      //var instane = new thirdwatch_api.SubmitReview();
      //expect(instance).to.be();
    });

    it('should have the property reviewContent (base name: "_reviewContent")', function() {
    ...
    it('should have the property submissionStatus (base name: "_submissionStatus")', function() {
      // uncomment below and update the code to test the property submissionStatus
      //var instane = new thirdwatch_api.SubmitReview();
      //expect(instance).to.be();
    });

    it('should have the property rating (base name: "_rating")', function() {
